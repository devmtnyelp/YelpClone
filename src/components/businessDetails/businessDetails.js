              ...
              <div className="biz-page-header-left">
                <div className="u-space-t1">
                  ...
                  <div className="totheleft">
                    ...
                    <span>
                      {this.props.details.details &&
                        this.props.details.details.review_count}{' '}
                      reviews
                    </span>
                  </div>
                  <div className="price-category">
                    {this.props.details.details &&
                      this.props.details.details.price}{' '}
                    •{' '}
                    {this.props.details.details &&
                      this.props.details.details.categories[0].title}
                    {this.props.details.details &&
                      this.props.details.details.categories[1] &&
                      ', '}
                    {this.props.details.details &&
                      this.props.details.details.categories[1] &&
                      this.props.details.details.categories[1].title}
                    {this.props.details.details &&
                      this.props.details.details.categories[2] &&
                      ', '}
                    {this.props.details.details &&
                      this.props.details.details.categories[2] &&
                      this.props.details.details.categories[2].title}
                  </div>
                </div>
              </div>
                  ...
                  <div className="mapbox-map">
                    {this.props.details.details && (
                      <MapContainer
                        ...
                        bizname={this.props.details.details.name}
                      />
                    )}
                  </div>
                  <div className="mapbox-text">
                    <ul>
                      ...
                      <li>
                        ...
                        {this.props.details.details &&
                          this.props.details.details.display_phone}
                      </li>
                    </ul>
                  </div>
                </div>
